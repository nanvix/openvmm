...
persisted ABI remains value 2 and its Linux-direct boot layout is value 3. The
...
SMBIOS data is exposed. Removed boot-layout value 2 snapshots are rejected.
